...
export const metadata: Metadata = {
    title: "Services - Azhar International Trading Est.",
            ...
            <Wrapper className='grid grid-cols-1 lg:grid-cols-[1fr_0.75fr] gap-8 xl:gap-16 w-screen py-16'>
                <div className='w-full h-full flex flex-col px-2 gap-4 lg:pt-14 order-2 lg:order-1 mb-14'>
                    ...
                    <p className='text-lg mt-8'>
                        At Azhar, we&apos;re dedicated to meeting the industrial spare parts and equipment needs of various industries. Our comprehensive suite of services is designed to streamline operations and reduce overseas purchasing costs for our clients. We handle all aspects of the procurement process, from packing and freight to insurance and local customs duties, ensuring seamless delivery to our clients&apos; specified locations.
                    </p>
                    <p className='text-lg'>
